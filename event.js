...
Event.prototype.toJSON = function () {
  return JSON.stringify({
    dances: JSON.stringify(this.dances),
    dancers: JSON.stringify(this.dancers),
    entries: JSON.stringify(this.entries),
    heats: JSON.stringify(this.heats),
    danceGroups: JSON.stringify(Array.from(this.danceGroups.entries()))
  });
}

Event.prototype.fromJSON = function(json) {
  let parsedJson = JSON.parse(json);
  this.dances = parsedJson.dances;
  this.dancers = parsedJson.dancers;
  this.entries = parsedJson.entries;
  this.heats = parsedJson.heats;
